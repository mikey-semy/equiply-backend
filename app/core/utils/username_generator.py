...
THEME_PROMPTS = {
    UsernameTheme.SPACE: (
        "Сгенерируй 5 уникальных имен пользователей на космическую тематику. "
        "Используй термины из астрономии, названия космических объектов, "
        "или связанные с исследованием космоса. Имена должны быть на английском, "
    ...
    UsernameTheme.FANTASY: (
        "Сгенерируй 5 уникальных имен пользователей на фэнтезийную тематику. "
        "Используй термины из мифологии, фэнтезийных миров, магии или средневековья. "
    ...
    UsernameTheme.MOVIES: (
        "Сгенерируй 5 уникальных имен пользователей на тему кино и фильмов. "
        "Используй термины из киноиндустрии, названия известных фильмов или имена персонажей. "
        "Имена должны быть на английском, состоять из 1-2 слов, разделенных подчеркиванием, "
        "без пробелов и спецсимволов. Верни только список имен, каждое с новой строки."
    ),
    UsernameTheme.GAMES: (
        "Сгенерируй 5 уникальных имен пользователей на игровую тематику. "
        "Используй термины из видеоигр, названия игровых персонажей или игровых вселенных. "
        "Имена должны быть на английском, состоять из 1-2 слов, разделенных подчеркиванием, "
        "без пробелов и спецсимволов. Верни только список имен, каждое с новой строки."
    ),
    UsernameTheme.ANIMALS: (
    ...
    UsernameTheme.SCIENCE: (
        ...
        "Используй термины из науки, технологий, программирования или математики. "
        "Имена должны быть на английском, состоять из 1-2 слов, разделенных подчеркиванием, "
        "без пробелов и спецсимволов. Верни только список имен, каждое с новой строки."
    ),
    UsernameTheme.RANDOM: (
