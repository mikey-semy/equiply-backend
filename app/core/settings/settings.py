...
class Settings(BaseSettings):
    ...
    TITLE: str = "Equiply"
    DESCRIPTION: str = (
        "Equiply — это современная система управления оборудованием, \
        предназначенная для автоматизации процессов обслуживания и оптимизации работы с техническими средствами. \
        Наша платформа помогает эффективно управлять, обслуживать и применять оборудование в различных сферах."
    )
    VERSION: str = "0.1.0"
    HOST: str = "0.0.0.0"
    PORT: int = 8000
