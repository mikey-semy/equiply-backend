...
def downgrade() -> None:
    ...
    op.add_column('list_items', sa.Column('workspace_id', sa.INTEGER(), autoincrement=False, nullable=False))
    op.create_foreign_key('list_items_workspace_id_fkey', 'list_items', 'workspaces', ['workspace_id'], ['id'], ondelete='CASCADE')
